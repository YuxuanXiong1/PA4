...
public class SymbolTableVisitor implements Visitor {
  ...
  public Object visit(ClassDecl node, Object data){
      ...
      node.i.accept(this, i.s);
      node.v.accept(this, "$" + i.s);
      node.m.accept(this, i.s);

      // Add class to symbol table
      symbolTable.classes.put("$" + i.s, node);
      symbolTable.typeName.put("$" + i.s, "*class");
  ...
  public Object visit(False node, Object data){ 
    ...
    public Object visit(MethodDecl node, Object data){
        ...
        // Prepend class name to method name
    ...
    public Object visit(VarDecl node, Object data){
        ...
        node.t.accept(this, data);
        node.i.accept(this, data);
        // Prepend class and method name to variable name
        String data2 = data + "$" + i.s;
        symbolTable.variables.put(data2, node);
        symbolTable.typeName.put(data2, getTypeName(t));
